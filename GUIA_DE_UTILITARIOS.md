# ScanBus-BR - Guia de Utilitarios / Utilities Guide

> Guia completo de cada utilitario, tela e ferramenta do ScanBus-BR (Sniffer, Scanners, Simulador de Slave, Tabelas, etc).
> Para apresentacao geral do projeto, download, licenca e contato, veja o [README.md](README.md).
